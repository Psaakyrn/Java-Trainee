...
public class DbOperations {
	...
	public static List<Student> displayRecords() {
		...
		try {
			...
			studentsList = sessionObj.createQuery("FROM Student",Student.class).list();
		} catch(Exception sqlException) {
			if(null != sessionObj.getTransaction()) {
				logger.info("\n.......Transaction Is Being Rolled Back.......\n");
				sessionObj.getTransaction().rollback();
	...
	public static Student findRecordById(Integer find_student_id) {
		...
		try {
			...
			findStudentObj = (Student) sessionObj.find(Student.class, find_student_id);
		} catch(Exception sqlException) {
			if(null != sessionObj.getTransaction()) {
				logger.info("\n.......Transaction Is Being Rolled Back.......\n");
				sessionObj.getTransaction().rollback();
	...
	public static void deleteAllRecords() {
		try {
			...
			Query<Object> queryObj = sessionObj.createQuery("DELETE FROM Student",null);
